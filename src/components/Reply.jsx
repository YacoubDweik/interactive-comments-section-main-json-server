...
function Reply({ replyData, currentUser, isYou, handleReplyClick, handleDeleteClick, handleEditClick }) {
    ...
    <div className="reply-container">
      ...
      <div className="reply-list">
        <div className="main-comment">
          <div className="score">
            <button className={`upvote-btn disabled`} onClick={() => handleUpvoteClick(id)}>
            ...
            <button className={`downvote-btn`} onClick={() => handleDownvoteClick(id)}>
          ...
          {!isYou && (
            <button className="reply-button" onClick={() => handleReplyClick(id)}>
          ...
          <div className="content">
            ...
            {isEditClicked && <TextBox currentUser={currentUser} content={`@${replyingTo} ${content}`} type={"edit"} />}
          </div>
        </div>
